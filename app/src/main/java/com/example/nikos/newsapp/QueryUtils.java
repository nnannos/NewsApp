...
//Changes
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Create a new {@link News} object with the title,sectionName, url, publicationDate
                // //from the JSON response.
                News newsresult = new News(title,authors.toString(), sectionName, url, publicationDate);
